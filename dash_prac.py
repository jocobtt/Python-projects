...
conn = psycopg2.connect("host=jinji-dashboarddb.csxjll4evytc.us-east-2.rds.amazonaws.com dbname=jinjidb user=jbrazzy1 port=5430 password=Kumamoto2014")
...
username_pass = [
    ['Jacob_Brasw','Bowerman109'], ['Tim_Jenkins','Passwords#2']
]
